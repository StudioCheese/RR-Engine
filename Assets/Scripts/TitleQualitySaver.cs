...
public class TitleQualitySaver : MonoBehaviour
{
    ...
    {
        int check = Mathf.Clamp(PlayerPrefs.GetInt("Settings: GI") + quality, 0, 3);
    ...
    public void UpdateSettings()
    {
        ...
        if (PlayerPrefs.GetInt("Settings: GI") >= 2)
        {
        ...
        if (PlayerPrefs.GetInt("Settings: GI") != 1)
        {
            texts[4].color = Color.white;
        }
        else
        {
            texts[4].color = Color.grey;
        }
        //5 Tex Res
